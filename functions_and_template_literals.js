...
const showFullName = (name, surname) => console.log(`My full name is ${name} ${surname}`)
showFullName (name, surname)

//Invoca una funció que retorni un valor des de dins d'una template literal:
const returnSurname = (surname) => surname
const returnFullName = (name, surname) => `${name} ${surname}`
console.log(`My name is ${returnSurname(surname)}, ${returnFullName(name, surname)}`)
...
const showUsername = (username) => console.log(username)
